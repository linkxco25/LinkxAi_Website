    ...
    <div class="container mx-auto px-6 relative z-10">
      <div class="max-w-md mx-auto bg-white/95 backdrop-blur-lg rounded-3xl shadow-2xl p-8 transform hover:scale-[1.02] transition-transform duration-300">
        <div class="text-center mb-8">
          ...
          <h1 class="text-3xl font-bold mb-2 bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Bon Retour</h1>
          <p class="text-gray-600">Connectez-vous à votre compte Linkx-AI</p>
        </div>
        ...
        <div class="mt-6 text-center">
          <p class="text-gray-600">
            ...
            <a href="/get-started" class="text-purple-600 hover:text-purple-700 font-semibold">Commencez Gratuitement</a>
          </p>
        </div>
        
        <div class="mt-8 pt-6 border-t border-gray-200">
          <p class="text-center text-sm text-gray-500 mb-4">Ou continuez avec</p>
